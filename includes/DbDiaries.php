...
class DbDiaries
{
    ...
    public function readAllPatientDiaries($patient_id)
    {
        $stmt = $this->conn->prepare("SELECT patient_id, date, sleep_time, change_residence, sport_time, alcohol, smoke, feeling FROM diary WHERE patient_id = ?");
